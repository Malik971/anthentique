...
export function BrandIcon({ platform, ...props }: BrandIconProps) {
  ...
  if (platform === "facebook") {
    return (
      <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073c0 6.027 4.388 11.02 10.125 11.927v-8.385H7.078v-3.542h3.047V9.37c0-3.017 1.792-4.683 4.533-4.683 1.312 0 2.686.236 2.686.236v2.965h-1.513c-1.49 0-1.956.93-1.956 1.883v2.302h3.328l-.532 3.542h-2.796V24C19.612 23.093 24 18.1 24 12.073Z" />
      </svg>
    );
  }
